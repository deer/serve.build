...
/**
 * Tests for LSP request/notification handlers not covered by {@link LspTransportTest}.
 *
 * @author reed.vonredwitz
 * @since Apr-2026
 */
class LspHandlersTest {
    ...
    void shouldReturnDefinitionLocation() throws Exception {
        ...
        try (final var client = new LspTransportTest.LspTestClient(server)) {
